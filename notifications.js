...
function buildEmailBody(type, p) {
  ...
  return '<!DOCTYPE html><html><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1"></head>' +
    ...
    '<p style="font-size:11px;color:#7a8fa6;margin:0">CapEye Auto Capital Command Centre · This is an automated notification · <a href="https://capeye.autocapital.co.uk" style="color:#003DA5">capeye.autocapital.co.uk</a></p>' +
    '</div></div></body></html>';
}
